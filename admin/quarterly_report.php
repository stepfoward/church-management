...
// Function to get donations for a specified quarter
function getDonationsByQuarter($conn, $start_date, $end_date) {
    ...
    echo "<h3>Ripoti ya Michango kwa Robo ya Mwaka</h3>";
    echo "</div>";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div class='alert alert-warning text-center'>Hakuna michango iliyorekodiwa kwa robo hii.</div>";
    }
...
<head>
    ...
    <title>Ripoti ya Michango kwa Robo</title>
    <style>
        body {
    ...
    <div class="row">
        ...
        <div class="col-md-3 ms-auto mt-3">
            <form action="" method="GET" class="d-flex flex-column gap-3">
                ...
                <button type="submit" class="btn btn-primary">Pata Ripoti ya Robo</button>
            </form>
        </div>

        <!-- Onyesha ripoti kulingana na robo -->
        <div class="col-md-10 ms-auto">
            ...
            if (isset($_GET['quarter'])) {
                ...
                // Set the start and end date for the selected quarter
                switch ($quarter) {
                    case 'Q1':
                ...
                getDonationsByQuarter($conn, $start_date, $end_date);
            }
            ?>
        </div>
    </div>
