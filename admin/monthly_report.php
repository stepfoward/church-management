...
// Function ya kupata michango kwa tarehe maalum
function getDonationsByDate($conn, $start_date, $end_date) {
    ...
    echo "<h3>Ripoti ya Michango kwa Tarehe</h3>";
    echo "</div>";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<div class='alert alert-warning text-center'>Hakuna michango iliyorekodiwa kwa tarehe hii.</div>";
    }
...
<head>
    ...
    <title>Ripoti ya Michango kwa Tarehe</title>
    <style>
        body {
    ...
    <div class="row">
        ...
        <div class="col-md-3 ms-auto mt-3">
            <form action="" method="GET" class="d-flex flex-column gap-3">
                ...
                <button type="submit" class="btn btn-primary">Pata Ripoti</button>
            </form>
        </div>
        ...
        <div class="col-md-10 ms-auto">
            ...
            if (isset($_GET['start_date']) && isset($_GET['end_date'])) {
                ...
                getDonationsByDate($conn, $start_date, $end_date);
            }
            ?>
        </div>
    </div>
